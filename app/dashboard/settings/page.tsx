                    ...
                    {permissions.map((perm) => (
                      <td key={perm.key} className="px-6 py-4 whitespace-nowrap text-center">
                        <input
                          ...
                          onChange={(e) =>
                            handlePermissionChange(user.id, perm.key, e.target.checked)
                          }
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-500">
                <p>
                  Changes to permissions will take effect on the user's next login. 
                  Be careful when modifying permissions for admin users.
                </p>
              </div>
            </div>
          </div>
